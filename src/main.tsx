...
// @ts-ignore
import GastosRecorrentes from './gastosRecorrentes.tsx'
// @ts-ignore
import VisaoGeral from './visaoGeral.tsx'
// @ts-ignore
        ...
        return (
          <div className="flex-1 p-6 md:p-8 overflow-y-auto w-full flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-2xl font-bold text-foreground mb-2">{currentPage === 'dashboard' ? 'Dashboard' : currentPage === 'relatorios' ? 'Relatórios' : 'Configurações'}</h1>
